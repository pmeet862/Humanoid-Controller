...
public class RotateAndMove : MonoBehaviour
{
    ...
    [SerializeField] bool _moveEnable = true;
    ...
    private void FixedUpdate()
    {
        ...
        if (_moveEnable)
        {
            ...
            // Debug.Log("distance: " + Vector3.Distance(_startPosition, _endPosition));
            _timeScale = _moveSpeed / Vector3.Distance(_startPosition, _endPosition);
